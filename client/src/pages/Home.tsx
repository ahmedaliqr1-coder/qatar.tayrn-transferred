  ...
  return (
    <div className="page-wrapper">
      <style>{`
        ...
        .logo { height: 100px; width: auto; object-fit: contain; background-color: white; padding: 5px; border-radius: 0; }
      ...
      <header className="header">
        <div className="header-right">
          ...
          <img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663834255146/jNmGelCTuaBjjTzY.jpg" className="logo" alt="logo" />
        </div>
